...
class BetaState:
    ...
    def update(self, won: bool, weight: float = 1.0) -> None:
        ...
        # move it called wrong hurts more than a tiny one. Aligns learning with
        # realized-profit magnitude, not flat hit-rate. weight=1.0 == original.
...
def _belief_weight(o: dict) -> float:
    ...
    more weight than trivial ones, bounded so one outlier can't dominate.
    ...
    try:
        ...
        return 1.0
    return max(0.5, min(3.0, 0.5 + mag / 2.0))
