...
"""
    ...
    for _nm51, _imp51 in (("multi-timeframe regime ladder", "mtf_regime.build_mtf_regime"),
                          ...
                          ("edge surface (cells·expectancy±CI)", "edge_surface.build_edge_surface"),
                          ("retention (archive·data ledger)", "retention.build_retention"),
                          ("question engine (asks everything)", "question_engine.build_questions"),
